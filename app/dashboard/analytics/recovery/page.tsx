  ...
  return <div className="space-y-10">
    <section><p className="eyebrow">Recovery analytics</p><h1 className="mt-2 text-3xl font-semibold">Audience recovery coverage</h1>
      ...
      <div className="mt-6 grid gap-3 sm:grid-cols-2 xl:grid-cols-5">
        <RecoveryCoverageCard label="Recovery coverage" value={`${overview.recovery_coverage_rate}%`} description="The percentage of your audience with a currently usable Recovery Pass." />
