...
values
  ...
  (
    ...
    '71000000-0000-0000-0000-000000000001', 'sms', 'verified',
    encode(extensions.digest('+14155552671', 'sha256'), 'hex'), '•••• •••• 2671', null, now()
  ),
  (
...
set selected_recovery_method_id = case connection.id
  ...
  when '72000000-0000-0000-0000-000000000005' then null
