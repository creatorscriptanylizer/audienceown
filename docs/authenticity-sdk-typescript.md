...
The verifier accepts both `audienceown-authenticity-v1` and v2 ecosystem assertions while retaining strict issuer, algorithm, key, expiry, and signature checks.
