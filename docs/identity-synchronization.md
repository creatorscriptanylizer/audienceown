...
The monitoring worker reuses provider identity fetchers and encrypted secret access, compares safe fingerprints, applies bounded exponential retry, and emits precise observations instead of generic changes.
