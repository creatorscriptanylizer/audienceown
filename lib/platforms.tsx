...
export const PLATFORM_IDS = [
  ...
  "facebook", "snapchat", "threads", "pinterest", "discord", "more",
] as const;
...
export const PLATFORMS: readonly PlatformDefinition[] = [
  ...
  { id:"tiktok", name:"TikTok", description:"Short-form video", category:"Video", aliases:["tt","shorts"], icon:FaTiktok, brandColor:"#f4f4f5", brandBackground:"linear-gradient(135deg,rgba(34,211,238,.14),rgba(244,63,94,.14))", fieldLabel:"Profile URL or handle", placeholder:"@nanakwame", helperText:"Add your main TikTok account.", databaseValue:"tiktok", domains:["tiktok.com","www.tiktok.com"], handleBaseUrl:"https://tiktok.com/@" },
  { id:"x", name:"X", description:"Posts & conversation", category:"Social", aliases:["twitter","tweets"], icon:FaXTwitter, brandColor:"#f4f4f5", brandBackground:"rgba(255,255,255,.08)", fieldLabel:"Profile URL or handle", placeholder:"@nanakwame", helperText:"Add your main X profile.", databaseValue:"x", domains:["x.com","www.x.com","twitter.com","www.twitter.com"], handleBaseUrl:"https://x.com/" },
  { id:"spotify", name:"Spotify", description:"Music & podcasts", category:"Music", aliases:["audio","podcast","artist"], icon:FaSpotify, brandColor:"#1ed760", brandBackground:"rgba(30,215,96,.12)", fieldLabel:"Artist or show URL", placeholder:"https://open.spotify.com/artist/…", helperText:"Add your main Spotify artist or show page.", databaseValue:"other", domains:["open.spotify.com"] },
  ...
  { id:"linkedin", name:"LinkedIn", description:"Professional profile", category:"Professional", aliases:["work","career","business"], icon:FaLinkedinIn, brandColor:"#60a5fa", brandBackground:"rgba(10,102,194,.14)", fieldLabel:"Profile or page URL", placeholder:"https://linkedin.com/in/nanakwame", helperText:"Add your main LinkedIn profile or page.", databaseValue:"other", domains:["linkedin.com","www.linkedin.com"] },
  { id:"facebook", name:"Facebook", description:"Page or profile", category:"Social", aliases:["fb","meta"], icon:FaFacebookF, brandColor:"#60a5fa", brandBackground:"rgba(24,119,242,.14)", fieldLabel:"Profile URL or handle", placeholder:"https://facebook.com/nanakwame", helperText:"Add your main Facebook page or profile.", databaseValue:"facebook", domains:["facebook.com","www.facebook.com","fb.com"], handleBaseUrl:"https://facebook.com/" },
  { id:"snapchat", name:"Snapchat", description:"Stories & moments", category:"Social", aliases:["snap","stories"], icon:FaSnapchat, brandColor:"#fde047", brandBackground:"rgba(255,252,0,.11)", fieldLabel:"Profile URL or handle", placeholder:"@nanakwame", helperText:"Add your main Snapchat profile.", databaseValue:"other", domains:["snapchat.com","www.snapchat.com"], handleBaseUrl:"https://snapchat.com/add/" },
  { id:"threads", name:"Threads", description:"Social conversation", category:"Social", aliases:["meta","posts"], icon:FaThreads, brandColor:"#f4f4f5", brandBackground:"rgba(255,255,255,.08)", fieldLabel:"Profile URL or handle", placeholder:"@nanakwame", helperText:"Add your main Threads profile.", databaseValue:"other", domains:["threads.net","www.threads.net"], handleBaseUrl:"https://threads.net/@" },
  { id:"pinterest", name:"Pinterest", description:"Ideas & inspiration", category:"Social", aliases:["pins","boards"], icon:FaPinterestP, brandColor:"#f43f5e", brandBackground:"rgba(230,0,35,.12)", fieldLabel:"Profile URL or handle", placeholder:"https://pinterest.com/nanakwame", helperText:"Add your main Pinterest profile.", databaseValue:"other", domains:["pinterest.com","www.pinterest.com"], handleBaseUrl:"https://pinterest.com/" },
...
export function platformFromAccount(platform: string, url: string): PlatformDefinition {
  ...
  try {
    ...
    return PLATFORMS.find((item) => item.databaseValue === "other" && item.domains.includes(hostname)) ?? PLATFORMS.at(-1)!;
  } catch {
