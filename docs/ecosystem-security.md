...
Automation-specific webhook, suppression, and retry boundaries are documented in [ecosystem automation](ecosystem-automation.md) and [ecosystem webhooks](ecosystem-webhooks.md).
