...
X and LinkedIn monitoring is isolated from emergency activation and Recovery Pass dispatch. Authority loss produces private monitoring state only; emergency preparation remains a separate creator-authorized workflow.
