...
function GoogleIcon() {
  return <svg aria-hidden="true" viewBox="0 0 24 24" className="size-5 shrink-0">
...
export function GoogleAuthButton({ next = "/onboarding" }: { next?: string }) {
  return <form action={signInWithGoogle}>
    ...
    <SubmitButton className="button google-button w-full" pendingText="Connecting to Google…">
      <span className="inline-flex items-center justify-center gap-3"><GoogleIcon />Continue with Google</span>
    </SubmitButton>
  </form>;
}
